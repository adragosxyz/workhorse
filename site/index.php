    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-9 mx-auto">
          <h1 class="mb-5">Try our VPS service now!</h1>
        </div>
  ...
  <section class="features-icons bg-light text-center">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="features-icons-item mx-auto mb-5 bm-lg-0 mb-lg-3">
            <div class="features-icons-icon d-flex">
              <i class="icon-check m-auto text-primary"></i>
            </div>
            <h3>Easy to Use</h3>
            <p class="lead mb-0">Practical enviroment.</p>
            <p class="lead mb-0">Customer friendly !</p>
